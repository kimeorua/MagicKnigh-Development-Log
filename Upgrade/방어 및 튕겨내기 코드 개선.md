...
{
	None = 0 UMETA(DisplayName = "None"),
	NormalAttack UMETA(DisplayName = "Normal Attack"), //ㅈ주중ㄱ가간공격
	LightAttack UMETA(DisplayName = "Light Attack"), //약한 공격
	HeavyAttack UMETA(DisplayName = "Heavy Attack"), //강한 공격
	SpecialAttack UMETA(DisplayName = "Special Attack"), //특수 공격
	SuperArmor UMETA(DisplayName = "Super Armor"), //슈퍼아머 상태일때 받는 데미지
